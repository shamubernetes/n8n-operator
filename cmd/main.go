...
import (
	...
	"github.com/shamubernetes/n8n-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5ddc3264.n8n.io",
	...
	if err := (&controller.N8nCredentialReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "N8nCredential")
		os.Exit(1)
	}
	if err := (&controller.N8nWorkflowReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "N8nWorkflow")
		os.Exit(1)
	}
	...
	if err := (&controller.N8nPluginReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "N8nPlugin")
		os.Exit(1)
	}
